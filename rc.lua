...
-- {{{ Tags
tags = {
   names = { " WEB ", " TERMINAL ", " FILES ", " MUSIC ", " VIDEO ", " GRAPHICS ", " OTHER " },
   layout = { layouts[1], layouts[3], layouts[2], layouts[4], layouts[4], layouts[4], layouts[4] }
}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "`", function () awful.util.spawn("gksudo pm-suspend") end),
